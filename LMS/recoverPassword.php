...
elseif (!empty($_POST["userEmail"]))
{
 	...
 	elseif (check_email())
	{
		...
		$sql = "SELECT user_name, first_name,last_name,type,password FROM users WHERE email='$email' ";
		...
		if ($result->num_rows > 0)
		{
    		...
    		while($row = $result->fetch_assoc()) 
    		{
			   ...
			   $mail->Body     = "Please follow the below instruction to reset the password.";
			   $mail->WordWrap = 50;  
			   ...
			   if(!$mail->Send()) 
   				...
   				else 
   				{
					...
					//header ('Location: passwordRecoverSuccess.php');
   				}
	} 
	else 
	{
  ...
  <div class="errors-passwordRecover" style="position: absolute;top: 196px;left: 25%;color: black;font-family: 'Titillium Web', sans-serif;">
    ...
    { ?>
    	...
    	<a id="cb" href="index.php">Home Page</a>
      	<a id="cb" href="forgotPassword.php" style="margin: 4px 15px;">Back</a>
